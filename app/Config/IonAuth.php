...
class IonAuth extends \IonAuth\Config\IonAuth
{
	 ...
	 */
    public $siteTitle                = 'homelymedic.com';       // Site Title, example.com
    public $adminEmail               = 'rajasthantech.info@gmail.com'; // Admin Email, admin@example.com
    public $defaultGroup             = 'members';           // Default group, use name
    public $partnerGroup             = 'partners';          // Partner Group
