...
<div class="main-content">
    <section class="section">
                        ...
                        <div class="pricing pricing-highlight shadow">
                            ...
                            <div class="pricing-padding">
                                <div class="pricing-price">
                                    <div>
                                        <?= $currency ?>
                                        <span><?= $tenure['price'] - $tenure['discounted_price']  ?></span>
                                        <h6> <strike> <?= $tenure['price'] ?> </strike> </h6>
                                    </div>
        ...
        <?php if (isset($paytm)) {
            $url = ($paytm_mode == "production") ? "https://securegw.paytm.in/" : "https://securegw-stage.paytm.in/";
        ?>
            <script src="<?= $url ?>merchantpgpui/checkoutjs/merchants/<?= $paytm_merchant_id ?>.js"></script>
        <?php } ?>
    </section>
</div>