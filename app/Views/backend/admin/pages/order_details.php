                                            ...
                                            <div class="col-lg-4 col-sm-6">
                                                <div class=" mb-4 card-border">
                                                    <div class="" style="background-color:#f2f1f6;border-radius:0.3rem">
                                                        ...
                                                        ?>
                                                        <?php $final_total = (str_replace(',', '', $order_details['total']) + str_replace(',', '', $order_details['visiting_charges']) - str_replace(',', '', $order_details['promo_discount'])); ?>
                                                        <ul class="text-dark" style="padding: 0;" class="mb-0">
                                                            <li class="flex items-center justify-between ml-2 mr-2 mt-1 pl-1 pt-3"><span>Total</span><span class="font-semibold"><span><?= !empty($order_details['total']) ? $currency . ($order_details['total'] - $tax) : "No data found" ?></span></span></li>
                                                            ...
                                                            <li class="fbg-dark  flex items-center justify-between mb-lg-n5  p-3 " style="background-color: #DFDDEB;"><span> <?= labels('Payable Total', "Payable Total") ?></span><span class="font-semibold"><span><?= !empty($final_total) ? $currency . ceil($final_total) : "" ?></span></span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <form id="myForm" method="post" enctype="multipart/form-data">
                                        <div class="card text-dark border-bottom" style="border: none!important;">
                                            ...
                                            <div class="row m-0 work_started_proof">
                                                <div class="col-md">
                                                    <input type="file" class="filepond" id="filepond2" name="work_started_files[]" multiple>
                                                </div>
                                            </div>
                                            <div class="row m-0 work_completed_proof">
                                                <div class="col-md">
                                                    <input type="file" name="work_complete_files[]" class="filepond" id="file[]" multiple>
                                                </div>
                                            </div>
                                            <div class="row m-0">
...
<script>
    $('#work_started_proof').bind('change', function() {
        var filename = $("#work_started_proof").val();
